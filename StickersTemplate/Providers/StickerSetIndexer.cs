...
namespace StickersTemplate.Providers
{
    ...
    public class StickerSetIndexer : IStickerSetIndexer
    {
        ...
        /// <inheritdoc />
        public Task<IEnumerable<Sticker>> FindStickersByQuery(string query, int skip = 0, int count = 45, CancellationToken cancellationToken = default(CancellationToken))
        {
